        ...
        {status === "success" ? (
          <div className="rounded-2xl bg-green-500/5 p-8 text-center ring-1 ring-green-500/10">
            ...
            <button
              ...
              className="mt-6 rounded-full bg-white/5 px-6 py-2 text-sm text-white/50 transition-colors hover:bg-white/10"
            >
              추가 제보하기
            </button>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            {/* 닉네임 */}
            <div>
              <label className="mb-1.5 block text-xs font-medium text-white/35">닉네임 (선택)</label>
              <input
                type="text"
                placeholder="익명"
                value={form.reporter_name}
                onChange={(e) => setForm({ ...form, reporter_name: e.target.value })}
                className="w-full rounded-xl bg-white/[0.04] px-4 py-3 text-sm text-white/80 ring-1 ring-white/5 placeholder:text-white/15 focus:outline-none focus:ring-white/15"
              />
            </div>
            ...
            <div>
              ...
              <select
                ...
                className="w-full rounded-xl bg-white/[0.04] px-4 py-3 text-sm text-white/80 ring-1 ring-white/5 focus:outline-none focus:ring-white/15"
              >
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full resize-none rounded-xl bg-white/[0.04] px-4 py-3 text-sm text-white/80 ring-1 ring-white/5 placeholder:text-white/15 focus:outline-none focus:ring-white/15"
              />
            </div>
            ...
            <button
              ...
              className="w-full rounded-xl bg-white/10 py-3 text-sm font-medium text-white/70 transition-colors hover:bg-white/15 disabled:opacity-50"
            >
