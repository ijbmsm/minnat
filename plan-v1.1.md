> ⚠️ **이 문서는 실제 코드보다 뒤처져 있습니다.** 현재 상태는 [`STATUS.md`](./STATUS.md) 를 보세요.
> 프론트엔드 항목(archive 뱃지, criminal_stage 단계 표시, "본인 입장 확인되지 않음",
> 방법론 페이지, 개인 종합점수 제거)은 **이미 구현 완료**인데 미완으로 표기돼 있습니다. (2026-09-16)
