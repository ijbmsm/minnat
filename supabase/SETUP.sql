...
-- ==========================================================================
-- [18/22] 016-saju-chart-snapshot.sql
...
DO $done$
BEGIN
  RAISE NOTICE '민낯 스키마 셋업 완료 — 마이그레이션 22건 적용';
END
$done$;
